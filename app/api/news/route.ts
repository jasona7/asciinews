...
// Fallback headlines when API fails or no key (updated 2026-05-09 13:00 UTC)
const FALLBACK_NEWS = [
  ...
  { headline: 'Strategy (MSTR) Q1 Tuesday May 5 print continues to weigh into the weekend with BTC trading $80,403 Saturday May 9 13:00 UTC on the Crypto.com tape (+0.44% 24h after the Friday $80,250 close and the Thursday $79,168 24h-low test) — at current spot the 818,334-BTC position (~3.9% of the 21M hard cap) at $75,532 cost / ~$61.83B basis sits at ~$3.99B unrealized gain, well above the February-trough mark-to-market though the Q1 reported $14.46B unrealized BTC hit / $12.54B GAAP net loss / -$38.25 EPS framework re-asserts itself if BTC slips into the mid-70s; the spot-BTC-ETF flow flip Thursday (-$277.5M out, ending the nine-day $2.7B inflow streak) compounds the operational overhang from the AWS US-East-1 thermal outage that took Coinbase exchange functions offline >5 hours — Saylor\'s May 5 conference-call pivot acknowledging the firm "would consider selling Bitcoin" to actively manage the balance sheet for per-share value remains the structural narrative shift, with the convertible / perpetual-preferred stack (0% 2027/28/30/31/32 converts, STRK/STRF/STRD) back into focus into the 1M-BTC FY26 target line and the BTC Yield 9.6% YTD; CLARITY Act May 21 markup deadline now the binding next catalyst with the Trump-Xi May 14-15 Beijing summit and the live Russia-Ukraine ceasefire (May 9-11) the macro overlay', category: 'company', related: 'MSTR' },
  { headline: 'Bitcoin held above the $80K line Saturday May 9 13:00 UTC trading $80,403.59 on the Crypto.com tape (+0.44% 24h, range $79,528.15-$80,678.62, last $80,403.59, 24h volume value ~$183.9M) extending the Friday US-session record-day bid as the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) took effect at midnight Moscow time even though both sides traded fire across the line within hours and Putin presided over his most pared-back Red Square parade in nearly two decades — first time without heavy military hardware on display since the early 2000s; Thursday May 7 spot-BTC-ETF flow flipped to -$277.5M ending a nine-day $2.7B inflow run (FBTC -$128.99M / IBIT -$98.02M), cumulative net inflow since launch sliding to $59.49B and total net assets falling to $106.77B from $108.76B prior session, IBIT still the largest spot Bitcoin ETF with >$66B AUM and ~812K-BTC holdings (~3.8% of total Bitcoin supply); Secretary Rubio said Saturday the US "should know something today" on Iran\'s response to the MoU framework via Pakistani mediation, warning Tehran against any move to control the Strait of Hormuz as "problematic and unacceptable" — Iran-MoU under review with parliamentary "American wish list" pushback, US Navy disabling two more Iranian tankers Friday keeping the geopolitical-risk overlay live into the Trump-Xi May 14-15 Beijing summit; CLARITY Act May 21 markup deadline binding into Memorial Day recess', category: 'crypto', related: 'BTC' },
  { headline: 'Ether extended the move above $2,300 Saturday May 9 13:00 UTC trading $2,316.18 on the Crypto.com tape (+1.35% 24h, range $2,269.69-$2,325.39, last $2,316.18, 24h volume value ~$69.5M) outperforming BTC again as the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) took effect at midnight Moscow time — Putin presiding over his most pared-back Red Square parade in nearly two decades (first time without heavy military hardware in ~20 years) even as both sides traded fire across the line within hours of the truce window opening; Thursday May 7 spot-ETH-ETF flow flipped negative -$103.52M with no fund posting positive flows (Fidelity FETH -$62.26M largest outflow, BlackRock ETHA -$26.31M), erasing most of the $271.61M cumulative gain from the May 1-6 four-positive-session run, but the May 1-3 whale-buying spree (140K ETH added, total whale holdings 13.78M→13.98M ETH) still anchors the bid-floor narrative; the April BLS payrolls upside surprise (+115K vs +65K cons, unemployment 4.3%) tempers the rate-cut probability matrix into June 16-17 FOMC, Secretary Rubio Saturday saying the US "should know something today" on Iran\'s MoU reply via Pakistani mediation while warning Tehran against any Hormuz-control move as "problematic and unacceptable" — the geopolitical overlay live into the Trump-Xi May 14-15 Beijing summit', category: 'crypto', related: 'ETH' },
  { headline: 'Solana extended its lead in the majors complex Saturday May 9 13:00 UTC trading $93.44 on the Crypto.com tape (+5.63% 24h, range $88.01-$94.19, last $93.44, 24h volume value ~$14.3M) holding the low-$90s reclaim two sessions on as altcoin-beta SOL +5.63% > XRP +2.37% > ETH +1.35% > BTC +0.44% the cleanest read of the Saturday tape — the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) taking effect even as both sides traded fire across the line in the opening hours and Putin presiding over his most pared-back Red Square parade in ~20 years (first time without heavy military hardware on display); structurally the monthly US-spot-SOL-ETF inflow trend has now declined six straight months — November 2025 ATH $419.38M → April $39.93M (weakest monthly print since the October 2025 launch) — but the late-April catalyst stack still anchors the bid (Visa and Meta expanding Solana payments, Solana Swiss Research Institute launch, April 28 quantum-resistant signature migration, Israel CMA BILS approval — 1:1 ILS-pegged stablecoin deploying on Solana with sub-400ms settlement, EY-audited reserves, Fireblocks custody); Secretary Rubio Saturday saying the US "should know something today" on Iran\'s MoU reply via Pakistani mediation while warning Tehran against Hormuz-control moves keeps the geopolitical overlay live into the Trump-Xi May 14-15 Beijing summit', category: 'crypto', related: 'SOL' },
  { headline: 'XRP held the $1.40 reclaim Saturday May 9 13:00 UTC trading $1.4206 on the Crypto.com tape (+2.37% 24h, range $1.3837-$1.4349, last $1.4206, 24h volume value ~$7.3M) easing slightly off the Friday $1.4294 close but staying clear of the four-rejection $1.40-resistance pattern that capped the prior 96 hours — altcoin-beta still ranking SOL +5.63% > XRP +2.37% > ETH +1.35% > BTC +0.44% on the Saturday tape with the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) now in effect even as both sides traded fire across the line in the opening hours; structurally the US spot XRP ETF complex still tracks $1.5B AUM across 7 products with 833.7M XRP locked (Goldman Sachs largest disclosed institutional holder at $153.8M), May 6 inflows +$13.03M held the bid through the broader May 7 BTC -$277.5M / ETH -$103.52M ETF flow flip — CLARITY Act May 21 markup deadline now the binding structural catalyst with Senator Lummis publicly committing "we are going to mark up the Clarity Act in May" and Banking Chair Tim Scott "nearing consensus, working toward a bipartisan markup," Polymarket odds for Clarity-signed-this-year ~47% (down from 82% February), Kalshi ~15% before July / ~37% before August, Tillis-Alsobrooks stablecoin-yield compromise (banning bank-equivalent yield, allowing "bona fide activities") backed by Coinbase and Circle keeps the bipartisan path live', category: 'crypto', related: 'XRP' },
  ...
  { headline: 'Secretary of State Marco Rubio said Saturday May 9 the US "should know something today" on Iran\'s formal response to the MoU framework via Pakistani mediation — warning Tehran in the same press exchange that any move to control or close the Strait of Hormuz would be "problematic and unacceptable" — capping a turbulent week in which the US Navy CENTCOM disabled two more Iranian oil tankers Friday (M/T Sea Star III and M/T Sevda) attempting to breach the US naval blockade of Iranian Gulf-of-Oman ports, the May 7 US strikes on Bandar Abbas and Qeshm Island responded to a combined Iranian missile-drone-small-boat attack on three US destroyers in Hormuz, and Iran fired 15 missiles at the UAE Monday wounding three at the Fujairah industrial complex (the second cross-Hormuz UAE attack of the week); Defense Secretary Hegseth said the April 8 ceasefire "certainly holds" for now despite the kinetic exchange, Trump calling the strikes "just a love tap" in an ABC News call, Iranian FM Abbas Araghchi saying Iran "will never bow to pressure" and parliamentary spokesperson Ebrahim Rezaei dismissing the MoU as "more of an American wish list than a reality" — Iranian Foreign Ministry spokesman Esmaeil Baghaei confirming authorities are still considering and would relay their response via Pakistani mediators when complete, Pakistani FM spokesman Tahir Andrabi "hopeful" the parties strike a deal soon', category: 'general', related: '' },
  { headline: 'The Trump-orchestrated three-day Russia-Ukraine Victory Day ceasefire (May 9-11, 1,000-for-1,000 prisoner exchange) took effect at midnight Moscow time Saturday May 9 — but Al Jazeera and Defense News reported both sides trading fire and blame within hours of the truce window opening, the dueling competing-ceasefires that collapsed earlier in the week (Russia\'s May 7-9 framework / Kyiv\'s parallel proposal) bleeding through into the Trump-mediated pause; Putin presided over his most pared-back Red Square Victory Day parade in nearly two decades, no heavy military equipment on display for the first time in ~20 years amid Ukrainian-drone-strike concerns, Zelensky issuing a tongue-in-cheek decree that he would "allow a parade to be held in Moscow" — Trump on Truth Social framed the pause as "the request was made directly by me" and "the beginning of the end" of the war, thanking both Putin and Zelensky after a Putin-Trump phone call earlier in the week where the two "emphasised our countries were allies during World War II"; the truce stacks on top of the fragile US-Iran ceasefire (April 8, in effect "for now" per Hegseth despite the May 7 US strikes on Bandar Abbas and Qeshm Island and Iran\'s 15-missile Fujairah salvo) and the Israel-Hezbollah April 16 truce that Israel has selectively breached this week — the de-escalation tape into the Trump-Xi May 14-15 Beijing summit with Boeing CEO Kelly Ortberg confirmed joining for a potential 500-aircraft mega-order', category: 'general', related: '' },
  { headline: 'UK Prime Minister Keir Starmer rejected resignation calls Saturday May 9 after Labour suffered ground losses in this week\'s local elections to a surging Reform UK — Nigel Farage\'s party making sweeping gains across English councils and the Scottish-Welsh-mayoral test cycle — Starmer telling reporters he would "not walk away and plunge the country into chaos" and committing to serve out his five-year term, the post-result reset stacking against the Reeves spring-statement fiscal box and the Bank of England\'s next rate decision; in parallel the FAO global-food-price index rose 1.6% in April for the third consecutive monthly gain (vegetable-oil and energy components driving most of the move on Hormuz-disruption pass-through), reasserting the inflation-stickiness frame against the Fed\'s four-dissent April 29 hold and the Bank of America-flagged "hawkish" Fed turn that could push the next US cut into 2027 per the Reuters wire post the +115K April BLS payrolls upside surprise; Trump-Xi Beijing summit countdown still tracks May 14-15 with Boeing CEO Kelly Ortberg, Citigroup\'s and Mastercard\'s CEOs joining the trip per CNBC for a potential 500-aircraft package, the Iran war "likely to take center stage" per CNBC analysis as Trump presses Beijing to lean on Tehran for the MoU framework — the Trump-orchestrated Russia-Ukraine three-day ceasefire (May 9-11) the diplomatic backdrop', category: 'general', related: '' },
