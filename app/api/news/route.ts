...
// Fallback headlines when API fails or no key (updated 2026-05-11 01:00 UTC)
const FALLBACK_NEWS = [
  { headline: 'Intel (INTC) closed Friday May 8 at a fresh ATH $130.57 (+15% session close, +19% intraday peak, +200%+ from the year-ago $18.96 trough and ~74% above the August 2000 dot-com peak of $74.88) on the WSJ Friday scoop confirmed in detail by CNBC, MacRumors and 9to5Mac that Apple and Intel have reached a preliminary chip-making agreement after more than a year of intensive talks — a structural step beyond the Bloomberg May 5 "exploratory" framing that had already lifted the stock to $113.01 Tuesday — with the deal landing Intel\'s foundry services as a secondary option to longtime partner TSMC for chips based on Apple\'s own designs (much like TSMC currently does), early indications pointing squarely at lower-end M-series silicon for select iPad and Mac models with the contract path potentially landing CPUs by 2027 (WSJ noting Apple "has concerns about using non-TSMC technology and may not ultimately move forward with another partner" if 18A/14A yields disappoint, discussions remain "early stage" with no firm orders); per CNBC the US government — Intel\'s largest shareholder since last year\'s 10% stake deal under CEO Lip-Bu Tan — played a major role bringing Apple to the table, Commerce Secretary Howard Lutnick having met repeatedly with Tim Cook over the past year (alongside Musk and Jensen Huang) to encourage Intel-foundry work, the strategic angle of strengthening US-fab capacity feeds the cleanest tech-supply-chain narrative into the Trump-Xi May 14-15 Beijing summit where the Iran war is now expected to take "center stage" per CNBC summit analysis', category: 'company', related: 'INTC' },
  ...
  { headline: 'Coinbase (COIN) caught further criticism over the weekend per CoinDesk and ThisNextWeb framing — the AWS US-East-1 thermal outage knocked exchange functions offline for ~7 hours Thursday-Friday (use1-az4 cooling failure cascading into EC2/EBS hardware failure, AWS confirming the duration also hit FanDuel and the CME Group platform), CEO Brian Armstrong calling the outage "never acceptable" and promising a full root-cause analysis even as the week packaged with 700 layoffs Monday, the $394M GAAP net loss Thursday and the Friday outage into what The Next Web called "the worst week" framing; the Q1 miss reaction ($1.41B revenue cons $1.48B / -31% YoY, $394.1M GAAP net loss / -$1.49 EPS hammered by $482M unrealized losses on crypto held for investment, transaction revenue $755.8M cons $805.2M with spot volumes -37% QoQ) prompted Clear Street, Barclays, Piper Sandler and BofA all to trim PTs, the stock still down ~15% YTD; the Senate Banking Committee CLARITY Act markup is now firmed for Thursday May 14 at 10:30 AM ET per CoinDesk and 247WallSt — Chairman Tim Scott pushing the bipartisan deal that Coinbase has publicly endorsed as the structural-crypto re-rate catalyst, with the Trump-Xi May 14-15 Beijing summit Day 1 overlap the macro cross-asset frame, some analysts staying constructive on the CLARITY tailwind and revenue diversification thesis even through the PT cuts', category: 'company', related: 'COIN' },
  ...
  { headline: 'Strategy (MSTR) Saylor formalized the framework Saturday May 9 with the post "BPS is EPS on the Bitcoin Standard" per Stocktwits / MSN — explicitly crowning Bitcoin-per-share as the principal capital-decision metric guiding equity, debt and credit decisions — even as BTC pushed $81,297 on the Crypto.com tape Sunday-into-Monday May 11 01:00 UTC (+0.81% 24h, range $80,273-$82,473) with the 818,334-BTC position (~3.9% of the 21M hard cap) at $75,537 avg cost / ~$61.83B basis now sitting on roughly +7.02% unrealized gain per Saturday\'s mark per The Block / Strategy.com; Saylor told Fortune Thursday his earlier remarks about selling Bitcoin were "intended to jam short-sellers and haters" — walking back the May 5 conference-call pivot acknowledging the firm "would consider selling Bitcoin" — but CFO Phong Le confirmed BTC will be sold to finance STRC dividends when mNAV falls below 1.0, with Saylor publicly describing the model on video as "buy 10 Bitcoin, sell one to fund dividends, buy 10 more, sell one more" per CoinDesk / Stocktwits; Polymarket has now priced meaningful odds Strategy sells some of its position this year per Decrypt, the convertible / perpetual-preferred stack (0% 2027/28/30/31/32 converts, STRK/STRF/STRD) back into focus into the 1M-BTC FY26 target and the Senate Banking CLARITY Act markup firmed for Thursday May 14 with the Trump-Xi May 14-15 Beijing summit the macro overlay', category: 'company', related: 'MSTR' },
  { headline: 'Bitcoin pushed back above $81K Sunday-into-Monday May 11 01:00 UTC trading $81,297.03 on the Crypto.com tape (+0.81% 24h, range $80,273.39-$82,472.65, last $81,297.03, 24h volume value ~$190.7M) extending the Friday US-session record-day bid as the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) entered its final day with both sides trading accusations of violations per WaPo / Al Jazeera / France 24 — Russia\'s MoD claiming over 1,000 Kyiv breaches in the Sunday daily briefing, Ukrainian regional heads reporting fatalities in Zaporizhzhia / Kherson and a Russian drone strike damaging a nine-storey apartment block in the second-largest city, Zelensky saying Russia "was not even particularly trying" to observe the truce while Putin said the war was "heading to an end" despite the violations; the rally was helped per Bitcoin.com / CoinPedia by Project Freedom — Trump\'s announced US Navy escort of neutral commercial vessels through the Strait of Hormuz following Iran\'s 14-point peace proposal — and a $300M+ short squeeze with 99,681 traders liquidated as BTC reclaimed $80K, weekly US-spot-BTC-ETF flows tracking ~$1B net inflow for the week per Cointelegraph framing extending the multi-week streak; Senate Banking CLARITY Act markup firmed Thursday May 14 at 10:30 AM ET per CoinDesk and 247WallSt — the Trump-Xi Beijing summit the same week the binding cross-asset overlay', category: 'crypto', related: 'BTC' },
  { headline: 'Ether reclaimed $2,346 Monday May 11 01:00 UTC trading $2,346.50 on the Crypto.com tape (+1.03% 24h, range $2,311.69-$2,382.49, last $2,346.50, 24h volume value ~$83.3M) tracking BTC on roughly 1.3-beta basis as the Trump-orchestrated Russia-Ukraine three-day Victory Day ceasefire (May 9-11, 1,000-prisoner exchange) entered its final day with both sides trading accusations of violations per WaPo / France 24 — Russia\'s MoD claiming over 1,000 Kyiv breaches, Ukrainian officials confirming Zaporizhzhia / Kherson casualties from drone and artillery in the past 24 hours, Zelensky saying Russia was "not even particularly trying" to observe the truce; structurally BlackRock\'s ETHA has crossed $10B AUM in 251 days (the third-fastest US ETF to that mark per Datawallet) and Fidelity\'s FETH matches the 0.25% sponsor fee with frequent waivers, even as the May 7 spot-ETH-ETF complex flipped -$103.5M and a single whale deposited 78,000 ETH (~$178M) to Binance Friday May 8 while BlackRock and Fidelity moved 35,394 ETH to Coinbase Prime — the institutional distribution / accumulation split keeping the May tape range-bound; the +115K April BLS payrolls upside surprise re-prices the Fed path with CME FedWatch showing ~70% probability of a June 16-17 hold and Boston Fed\'s Collins siding with the four April-29 dissenters, Brent reclaimed $100 Friday on the Strait-of-Hormuz exchange — Senate Banking CLARITY Act markup firmed Thursday May 14 with the Trump-Xi Beijing summit the same-week macro overlay', category: 'crypto', related: 'ETH' },
  { headline: 'Solana led the altcoin tape Monday May 11 01:00 UTC trading $95.45 on the Crypto.com tape (+2.67% 24h, range $92.62-$96.90, last $95.45, 24h volume value ~$15.9M) breaking above the $93 descending-resistance trendline that had capped upside since early March per CoinPedia — altcoin-beta now ranking SOL +2.67% > XRP +2.71% > ETH +1.03% > BTC +0.81% on the Monday early-UTC tape after a roughly $33M weekly inflow into US spot Solana ETFs per CoinPedia / MEXC framing reasserted institutional interest into the breakout; structurally monthly US-spot-SOL-ETF inflows have declined six straight months (November 2025 ATH $419.38M → April 2026 $39.93M, the weakest print since the October 2025 launch) so even a flat May would be the first stabilization of the trend, the late-April catalyst stack still anchoring the bid (Visa and Meta expanding Solana payments, Solana Swiss Research Institute launch, April 28 quantum-resistant signature migration, Israel CMA BILS approval — 1:1 ILS-pegged stablecoin on Solana with sub-400ms settlement, EY-audited reserves, Fireblocks custody) plus the Alpenglow upgrade pushing transaction finality toward sub-150ms; the Trump-Xi May 14-15 Beijing summit the cross-asset overlay with US sanctions on fresh Chinese companies linked to Iran six days ahead of the trip the binding bilateral irritant, Senate Banking CLARITY Act markup firmed Thursday May 14 the same-week structural catalyst', category: 'crypto', related: 'SOL' },
  { headline: 'XRP broke above $1.45 Monday May 11 01:00 UTC trading $1.4547 on the Crypto.com tape (+2.71% 24h, range $1.4118-$1.5079 with a Sunday wick to $1.51, last $1.4547, 24h volume value ~$14.8M) — green-leading the majors with rankings now SOL +2.67% > XRP +2.71% > ETH +1.03% > BTC +0.81% as the Senate Banking Committee CLARITY Act markup countdown tightens (Chair Tim Scott firmed Thursday May 14 at 10:30 AM ET per CoinDesk / 247WallSt — the bill that would permanently classify XRP a digital commodity, 24/7 Wall St projecting a committee-pass scenario lifts XRP into the $1.70-$2 range with full-Senate passage targeting $3-$4 year-end and $5+ on ~$5B cumulative ETF inflow); structurally the US spot XRP ETF complex pulled in $28.1M across just three days May 4-6 with cumulative inflows now ~$1.32B since launch and Standard Chartered projecting $4-8B cumulative inflows by year-end if the bill passes — but ~$3B of sell-wall sits parked above $1.45 per FXLeaders triangle-apex framing so the committee pass alone may not be enough to absorb the full overhead; the Trump-Xi May 14-15 Beijing summit Day 1 overlap the macro cross-asset frame, banking-industry pushback flagged in a weekend Decrypt note arguing the proposal "would enable evasion" of the bank-regulatory perimeter and Senator Warren\'s Meta-stablecoin-disclosure ask the friction sitting alongside the markup', category: 'crypto', related: 'XRP' },
  { headline: 'US spot Bitcoin ETFs tracked roughly $1B in net inflows for the week ending Friday May 9 per Cointelegraph / Bitbo framing — extending the multi-week net-positive streak that has held BTC anchored above $80K through the Russia-Ukraine ceasefire weekend — even after the May 7 single-session flip negative at -$277.5M (FBTC -$128.99M / IBIT -$98.02M), the cumulative net inflow since launch holding above $59.5B and IBIT still the largest spot BTC ETF (>$66B AUM, ~810K-BTC holdings, now larger by AUM than most of BlackRock\'s gold and EM ETFs combined); April closed at $2.44B net inflow per Coinglass / SpotedCrypto — the strongest monthly figure since October 2025 — with the week ending April 24 delivering $823.70M in net inflows the largest single-week of the streak, the ETH complex turning negative the same May 7 session at -$103.52M with no fund posting positive flows (FETH -$62.26M, ETHA -$26.31M) erasing most of the $271.61M cumulative gain from the May 1-6 four-positive-session run; the flow tape rebounded into the weekend with BTC pushing $81,297 Monday 01:00 UTC and ETH $2,346.50 (+1.03%) on the back of Project Freedom Hormuz de-escalation, the +115K April BLS payrolls upside surprise and Senate Banking CLARITY Act markup firmed Thursday May 14 — IBIT crossed $10B AUM in 251 days the third-fastest US ETF to that mark per Datawallet', category: 'crypto', related: 'BTC' },
  { headline: 'S&P 500 closed Friday May 8 at a record 7,398.93 (+0.84%) and the Nasdaq Composite at a record 26,247.08 (+1.71%, crossing 26,000 for the first time in history) — both posting fresh all-time intraday and closing highs and a sixth straight weekly gain (S&P +2.3% / Nasdaq +4.5% on the week, longest weekly win streak since 2024 per CNBC) — as the April BLS payrolls upside surprise (+115K vs ~+65K cons, unemployment 4.3% steady) and the WSJ Friday scoop that Apple and Intel have reached a preliminary chip-making agreement drove tech-led leadership into the close, the Dow inched up just 12.19 points / +0.02% to 49,609.16 with rotation into the AI-hardware complex (INTC +15% to $130.57 ATH peak +19% intraday, AAPL +1.7%) absorbing most of the index-level upside; Akamai (AKAM) +28.5% on the Q1 raised-full-year guide and Rackspace (RXT) +12.5% on the AMD enterprise-AI-cloud MoU added to the AI-pipe leverage trade, the bid persisted through fresh US-Iran exchange of fire in the Strait of Hormuz Thursday-Friday (US CENTCOM strikes after three Navy guided-missile destroyers came under attack from Iranian missiles, drones and small boats per Al Jazeera) — Brent reclaimed $100 Friday with the international benchmark holding $101.12 per Al Jazeera, the diplomatic-progress hopes from the Witkoff-Kushner 14-point MoU overriding the kinetic risk into the Trump-Xi May 14-15 Beijing summit countdown', category: 'general', related: '' },
  ...
  { headline: 'The Trump-orchestrated three-day Russia-Ukraine Victory Day ceasefire (May 9-11, 1,000-for-1,000 prisoner exchange) entered its final day Sunday May 10 with both sides trading accusations of violations per Washington Post / Al Jazeera / France 24 / ABC News — Russia\'s Ministry of Defense in a daily briefing accusing Kyiv of more than 1,000 ceasefire violations, Ukrainian regional heads reporting one killed and three wounded in Zaporizhzhia and seven wounded in Kherson over the prior 24 hours from artillery and drone attacks, a Russian drone damaging a nine-storey apartment block in Ukraine\'s second-largest city wounding five — Zelensky telling reporters Russia was "not even particularly trying" to observe the truce and pledging retaliation; Putin nonetheless said the war was "heading to an end" per France 24 even as the front-line tempo persisted, the Saturday Red Square parade played out as his most pared-back in nearly two decades (first time without heavy military hardware in ~20 years amid Ukrainian-drone-strike concerns), Trump on Truth Social framing the pause as "the beginning of the end" and "directly requested by me"; the truce stacks on top of the fragile US-Iran ceasefire (April 8, in effect "for now" per Hegseth despite the May 7 US CENTCOM strikes on Bandar Abbas / Qeshm Island and the Thursday-Friday Hormuz exchange) into the Trump-Xi May 14-15 Beijing summit', category: 'general', related: '' },
  ...
  { headline: 'Iran is still reviewing the 14-point one-page MoU negotiated by US Special Envoy Steve Witkoff and Trump son-in-law Jared Kushner via direct and Pakistani-mediated channels per Axios / Times of Israel / Al Jazeera / CNN Politics — the framework declaring an end to the war and creating a 30-day window for detailed talks on the nuclear program, Strait of Hormuz de-escalation and the transfer of Iran\'s highly enriched uranium, with Iran committing to a moratorium on nuclear enrichment, the US agreeing to lift sanctions and release frozen Iranian funds, and both sides lifting Strait-of-Hormuz transit restrictions, sanctions-relief scope the principal outstanding hurdle; Trump told CNN Friday he expected to hear back "later that evening" but as of Sunday no clear Iranian response had landed, US-Iran talks expected to resume in Islamabad next week per Daily Pakistan, Secretary Rubio earlier framing Operation Epic Fury as "concluded" while pushing back on Tehran\'s preference to settle Hormuz first / nuclear later — Hegseth said the April 8 ceasefire "certainly holds for now" despite the May 7 US strikes on Bandar Abbas and Qeshm Island, the Thursday-Friday Hormuz exchange (US CENTCOM strikes after three Navy guided-missile destroyers came under attack from Iranian missiles, drones and small boats per Al Jazeera with Brent reclaiming $100 / $101.12), Trump announcing Project Freedom Navy escort of neutral commercial vessels per CoinPedia / Bitcoin.com framing tying the de-escalation to the Friday risk-on bid', category: 'general', related: '' },
