...
// Fallback headlines when API fails or no key (updated 2026-05-06 01:00 UTC)
const FALLBACK_NEWS = [
  ...
  { headline: 'US Tuesday closed at fresh records with S&P 500 +0.81% to 7,259.22 ATH / Nasdaq +1.03% to 25,326.13 ATH / Dow +0.73% (+356.35) to 49,298.25 / Russell 2000 intraday record on the de-escalation trade as Trump paused Project Freedom citing "great progress" on an Iran agreement, oil reversed sharply lower (WTI -3.9% to settle $102.27, Brent -2.8% to $109.85 from Monday\'s 2026-high $114.44 close), 10Y at 4.32% — earnings driver mixed: PYPL -10% on weak guide despite top-line beat, SHOP -7% on EPS miss, TSN higher on F2Q beat, AMD into AMC delivering the post-close blowout that lit S&P/Nasdaq futures green; the gating Wednesday-Thursday docket: Disney Wednesday May 6 BMO ($24.84B cons / $1.49 EPS, ~$500M SVOD operating-income target, Josh D\'Amaro\'s first as CEO post-Iger transition), Coinbase Thursday May 7 AMC ($1.5B rev / $0.26 EPS cons, -26% YoY, 14% workforce cut announced last week), April BLS payrolls Friday 8:30am ET (cons +49K vs +178K March, unemployment 4.3%) with the four-dissent April 29 FOMC hold (3.50-3.75%) leaving June 16-17 the next live decision', category: 'general', related: '' },
  ...
  { headline: 'Bitcoin softened to $80,999 Tuesday evening (-0.4% from the $81,305 Monday high, intraday range $80,079-$81,800, +1.1% 24h on continued ETF demand) after rejecting the $81,800 zone three times during the AMD-print-driven session, the $80K psychological level holding the floor on $2.44B April US-spot-ETF inflows (strongest month since October 2025, +$629.7M single-day May 1) and IBIT ~812K BTC valued ~$66B with 62% spot-ETF market share, total spot-BTC-ETF AUM $103.78B record — Strategy\'s Q1 print Tuesday confirmed 818,334 BTC at $75,537 cost (now +$4.4B unrealized gain after the February rebound from $62K), with the BlackRock+Fidelity-led ETF complex absorbing the corporate buying overhang as Coinbase Thursday May 7 AMC ($1.5B rev / $0.26 EPS cons, -26% YoY) the next gating event for the broader exchange/altcoin complex along with the CLARITY Act May 21 markup deadline (Senate Banking Chair Tim Scott under pressure from Senator Tillis to schedule the markup before Memorial Day recess or the bill likely shelves into 2030)', category: 'crypto', related: 'BTC' },
  { headline: 'Ether $2,363 Tuesday -1.1% from Monday\'s $2,390 high (24h range $2,353-$2,400, the $2,300 handle holding through the AMD-print-driven session at $137M 24h volume on Crypto.com alone) as ETH continued to lag BTC on relative strength even with US spot ETH ETFs flipping to a $101.2M net inflow May 1 — that print reversed the four-day $183.7M outflow stretch April 27-30, April finished at +$356M (first monthly net-inflow gain since October 2025 though still -$413M YTD), whales added 140K ETH in a four-day buying spree May 1-3 (total whale holdings 13.78M→13.98M ETH); the four-dissent FOMC vote 8-4 (Miran for cut, three dissents on the language) at the April 29 Powell-final-meeting hold (3.50-3.75%) leaves June 16-17 the next live decision with updated SEP, the Trump-paused Project Freedom de-escalation Tuesday capping the geopolitical risk-bid that had supported BTC over ETH through the prior 72 hours and the question whether the BTC/ETH ratio compresses on a Coinbase-print-driven altcoin bid Thursday', category: 'crypto', related: 'ETH' },
  { headline: 'XRP $1.4101 Tuesday +1.1% 24h (range $1.3939-$1.4221, the $1.40 reclaim level holding for the second straight session after rejecting for ~10 sessions previously, $1.45 the next watched leg) as US spot XRP ETFs snapped their longest 2026 inflow streak Apr 30 with $5.83M outflow (zero outflow days April 10-29, ~20 trading days, monthly gross $82M) — cumulative net inflows $1.29B across 7 products with combined AUM ~$1B and 828.3M XRP locked, Goldman Sachs the largest disclosed institutional holder at $153.8M, and the CLARITY Act calendar collapsing fast: 120 crypto firms petitioned the Senate Banking Committee, Senator Tillis pledged to press Chairman Tim Scott to schedule the markup when the Senate returned May 11, Memorial Day recess starts May 21 — if Scott doesn\'t markup before recess the bill likely shelves until 2030 per multiple Hill sources; the Trump-Iran de-escalation Tuesday plus the AMD blowout combine for the cleanest macro+sector tailwind into Coinbase Thursday May 7 AMC and the structural altcoin re-rating thesis', category: 'crypto', related: 'XRP' },
  { headline: 'Solana $86.32 Tuesday +2.5% 24h (range $84.13-$86.97, leading the major-coin tape on relative strength as buyers ran the $85 pivot and the $88-90 resistance zone the next watched level into Wednesday) firming alongside risk-on after Trump paused Project Freedom and AMD blew out — US spot SOL ETFs went the other way with SOLZ posting a -$585K outflow May 1 (~0.57% of AUM) as the sixth straight monthly decline played out (November 2025 $419.38M → April 2026 $39.93M, weakest month since October 2025 launch), AUM still through $1B with Goldman disclosed at $108M; the late-April catalysts still in the bid: Visa and Meta expanding Solana payments, Solana Swiss Research Institute launch, the April 28 quantum-resistant signature migration live alongside Israel CMA\'s BILS approval (1:1 ILS-pegged stablecoin) deploying on Solana with sub-400ms settlement, EY-audited reserves and Fireblocks custody — Coinbase Q1 earnings Thursday May 7 AMC the next gating event for the broader exchange/altcoin tape and the SOL-vs-ETH relative-strength thesis', category: 'crypto', related: 'SOL' },
  ...
  { headline: 'Disney (DIS) into Wednesday May 6 BMO Q2 print with consensus $24.84B revenue (+5.96% YoY) / $1.49 EPS (-2.76% YoY) and the ~$500M streaming operating-income tell on the 10% DTC margin target before fiscal year-end — Polymarket pricing 93.1% odds of clearing the $1.49 EPS bar, the stock at $101.70 +5.6% over the trailing 30 days, Wednesday\'s call CEO Josh D\'Amaro\'s first since formally taking the reins March 18 (Bob Iger transition complete) with the gating items: Disney+/Hulu/ESPN+ ARPU and ad-tier traction (the Netflix $3B FY26 ad-revenue ramp and 60%+ ad-supported new-sub mix the direct comp), Parks & Experiences segment with International visitation softness + Disney Adventure pre-launch + World of Frozen pre-opening cost drags into the quarter, the Hulu-Disney+ unification economics post-Comcast settlement, ESPN flagship-app trajectory, and the Cars Land + Avatar/Coco park expansion capex update — into a tape that just closed at fresh S&P/Nasdaq records on the Iran de-escalation and the AMD AMC blowout', category: 'company', related: 'DIS' },
